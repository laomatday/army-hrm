        ...
        <div className="pt-28 pb-32 px-4 animate-fade-in">
            ...
            {pendingCount > 0 && (
                <div 
                    ...
                    className="bg-neutral-white dark:bg-dark-surface rounded-[28px] p-5 mb-8 border border-primary/20 dark:border-primary/30 relative overflow-hidden group active:scale-[0.98] transition-all cursor-pointer animate-slide-up shadow-sm"
                >
                    ...
                    <div className="relative z-10 flex items-center justify-between">
                        <div>
                             <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-[10px] font-extrabold uppercase tracking-wider text-primary dark:text-primary bg-primary/10 dark:bg-primary/20 px-2 py-0.5 rounded-md border border-primary/20 dark:border-primary/30">Cần duyệt ngay</span>
                            </div>
                        ...
                        <div className="w-14 h-14 bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary rounded-2xl flex items-center justify-center text-xl border border-primary/20 dark:border-primary/30 group-hover:bg-primary dark:group-hover:bg-primary group-hover:text-neutral-white transition-all duration-300">
            ...
            <div className="space-y-4">
                {myNotifications.length === 0 && pendingCount === 0 ? (
                    ...
                    <>
                        {myNotifications.length > 0 && <h4 className="text-xs font-bold text-primary dark:text-primary uppercase ml-2 mb-2 tracking-widest animate-slide-up">Cập nhật của bạn</h4>}
                        {myNotifications.map((item: any) => {
                            ...
                            const statusColor = isApproved 
                                ...
                                : 'bg-secondary-red/10 dark:bg-secondary-red/20 text-secondary-red dark:text-secondary-red border border-secondary-red/20 dark:border-secondary-red/30';
                            ...
                            return (
                                <div key={item.id} className="bg-white dark:bg-dark-surface p-5 rounded-[28px] border border-slate-100 dark:border-dark-border animate-slide-up relative overflow-hidden group active:scale-[0.98] transition-all shadow-sm">
                                    ...
                                    {item.manager_note && (
                                        <div className={`mt-3 px-4 py-3 rounded-2xl border text-xs font-medium flex items-start gap-2 ${isApproved ? 'bg-primary/10 dark:bg-primary/20 border-primary/20 dark:border-primary/30 text-primary dark:text-primary' : 'bg-secondary-red/10 dark:bg-secondary-red/20 border-secondary-red/20 dark:border-secondary-red/30 text-secondary-red dark:text-secondary-red'}`}>
