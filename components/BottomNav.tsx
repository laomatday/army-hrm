    ...
    return (
        <button 
            ...
            className={`relative flex items-center justify-center w-12 h-12 rounded-full transition-all duration-300 active:scale-90 ${
                ...
                : 'text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 hover:bg-slate-50 dark:hover:bg-neutral-black/50'
            }`}
        >
      ...
      <div className="bg-neutral-white dark:bg-neutral-black rounded-full shadow-[0_20px_40px_-10px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.4)] flex items-center justify-between px-2 py-2 border border-slate-100/80 dark:border-slate-700/80 gap-1.5 backdrop-blur-md bg-opacity-90 dark:bg-opacity-90">
          ...
          >
               ...
               {notiCount > 0 && !isNotiActive && (
                    <span className="absolute top-2.5 right-2.5 bg-secondary-red text-neutral-white text-[9px] font-extrabold px-1 h-3.5 min-w-[14px] flex items-center justify-center rounded-full ring-2 ring-neutral-white dark:ring-neutral-black shadow-sm animate-pulse z-20 leading-none">
