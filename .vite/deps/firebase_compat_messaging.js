...
function getDbPromise3() {
  if (!dbPromise3) {
    dbPromise3 = openDB(DATABASE_NAME3, DATABASE_VERSION3, {
      upgrade: (upgradeDb, oldVersion) => {
        switch (oldVersion) {
          case 0:
...
var ERROR_FACTORY3 = new ErrorFactory("messaging", "Messaging", ERROR_MAP2);
...
var name3 = "@firebase/messaging-compat";
var version3 = "0.2.12";
