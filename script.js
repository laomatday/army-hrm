const API_URL = "https://script.google.com/macros/s/AKfycbxf_mPjDYnmnvzrdpO6WRBGiPDAr393YJor9VWTWY9-u4sglaSBA5fScamHzCncCWSZtg/execc";
...
window.takePicture = function () {
    ...
    navigator.geolocation.getCurrentPosition(
        async function (p) {
            // GỌI API CHECK-IN
            const r = await callAPI("doCheckIn", [{
...
window.triggerCheckOut = function () {
    showDialog("confirm", "Check-out", "Bạn muốn kết thúc ca làm việc?", async function () {
        showLoading(true);
        // GỌI API CHECK-OUT
        const r = await callAPI("doCheckOut", [{ employeeId: currentUser.Employee_ID }]);
...
// ==========================================
// 10. CÁC LOGIC KHÁC (REQUESTS, CONTACTS...)
// ==========================================
